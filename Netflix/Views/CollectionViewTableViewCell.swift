...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    private func downloadTitleAt(indexPath: IndexPath) {
        ...
        DataPersistanceManager.shared.downloadTitleWith(model: titles[indexPath.row]) { result in
            switch result {
            case .success():
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "downloaded"), object: nil, userInfo: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APIManager.shared.getMovie(with: titleName + " trailer") { [weak self] result in
            ...
            case .success(let videoElement):
                ...
                let viewModel = TitlePreviewViewModel(title: titleName, overviewTitle: titleOverview, webViewElement: videoElement)
